...
<div class="container-fluid" style=" padding-left:13%;">
	<div class="movie-card">
		...
		<div class="movie-content">
			<div class="movie-content-header">
				<a href="#">
					<h3 class="movie-title">Doctor Sleep</h3>
				</a>
    ...
    <div class="movie-card">
		...
		<div class="movie-content">
			<div class="movie-content-header">
				<a href="#">
					<h3 class="movie-title">Jumanji: The Next Level</h3>
				</a>
				<div class="imax-logo"></div>
			</div>
			<div class="movie-info">
...
<div class="movie-card">
		<div class="movie-header joker-movie">
			<div class="header-icon-container">
				<a href="#">
					<i class="material-icons header-icon"></i>
				</a>
		...
		<div class="movie-content">
			<div class="movie-content-header">
				<a href="#">
					<h3 class="movie-title">Spies in Disguise</h3>
				</a>
				<div class="imax-logo"></div>
			</div>
			<div class="movie-info">
