                ...
                <tr>
                    <?php if ($this->_tpl_vars['depth'] == 0): ?>
                        <?php if ($this->_tpl_vars['DataGrid']['AllowSelect']): ?>
                            <th class="row-selection" style="width:<?php if (count ( $this->_tpl_vars['DataGrid']['SelectionFilters'] ) > 0): ?>45px<?php else: ?>1%<?php endif; ?>;" rowspan="<?php echo $this->_tpl_vars['DataGrid']['ColumnGroup']->getDepth(); ?>
">
                                <?php if (count ( $this->_tpl_vars['DataGrid']['SelectionFilters'] ) > 0): ?>
                                        ...
                                        <li>
                                            ...
                                            <div id="selection-filters-content" class="hide">
                                                <ul class="list-unstyled dropdown-menu selection-filters">
                                                    <?php $_from = $this->_tpl_vars['DataGrid']['SelectionFilters']; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['filter']):
?>
                                                    <li><a href="#" class="js-action" data-filter-name="<?php echo $this->_tpl_vars['filter']; ?>
" data-url="<?php echo $this->_tpl_vars['Page']->getLink(); ?>
" data-handler-name="<?php echo $this->_tpl_vars['Page']->GetRecordsSelectionHandler(); ?>
